        ...
        <input type="hidden" name="task" value="contrats">
          ...
          <div class="section1" id="cont1" style="padding-left:5px">
              <div id='myagro_id' style="width:50%;">
                ...
                <span title="Entrez le numéro de client">
                  <input type="text" width="30" class='populateInput' name='myagro_num' id='myagro_num' value='<?php echo $row['clientID'];?>' readonly="true"  /></span>
          ...
          <div class="section1" id="cont2" style="padding-left:5px;">
              <table width="100%">
                ...
                <tr>
                     <td><input type="text" id="nom" name="nom" value=<?php echo $lname;?> size="15" readonly="true" /></td>
                    <td><input type="text" id="prenom" name="prenom" value=<?php echo $fname;?> size="15" readonly="true" /></td>
                    <td>
